/*
 * 9 - Interrupt and 16-BitTimerCount.c
 *
 * Created: 09-03-2025 13:58:52
 * Author : avinash
 
  
 The program utilizes 16-bit Timer/Counter (TCNT1) with a prescaler of 64 to create "1-second" interval.
